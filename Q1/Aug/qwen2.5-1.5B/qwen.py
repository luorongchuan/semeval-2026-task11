...
class NLIConfig:
    ...
    batch_size: int = 5          # ← 减小 batch size
    epochs: int = 5
...
def train_model(data, cfg: NLIConfig):
    ...
    training_args = TrainingArguments(
        output_dir='/home/luorongchuan/workspace_134/Semeval2026/Q1/code/qwen2.5-1.5b-aug/out',
        eval_strategy="epoch",
    ...
    trainer.train()
    model_save_path = "/home/luorongchuan/workspace_134/Semeval2026/Q1/code/qwen2.5-1.5b-aug/out"
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "/home/luorongchuan/workspace_134/Semeval2026/Q1/code/qwen2.5-1.5b-aug/predictions.json"
    MODEL_SAVE_DIR = "/home/luorongchuan/workspace_134/Semeval2026/Q1/code/qwen2.5-1.5b-aug/out"
