...
@dataclass
class NLIConfig:
    model_name: str = "Qwen/Qwen2-1.5B"  # ← 改为 Qwen
    max_length: int = 512
...
def train_model(data, cfg: NLIConfig):
    ...
    training_args = TrainingArguments(
        output_dir='/home/luorongchuan/workspace_134/Semeval2026/Q1/out_qwen',
        eval_strategy="epoch",
    ...
    trainer.train()
    trainer.save_model("/home/luorongchuan/workspace_134/Semeval2026/Q1/out_qwen")
...
def predict_on_test_set(test_filepath: str, model_path: str, tokenizer_name: str, output_json_path: str, max_length: int = 512):
    ...
    model = QwenForSequenceClassification.from_pretrained(model_path, num_labels=2)
    model.eval()
...
if __name__ == "__main__":
    ...
    cfg = NLIConfig(
        model_name="Qwen/Qwen2-1.5B",  # ← Qwen 模型
        max_length=512,
    ...
    OUTPUT_FILE = "/home/luorongchuan/workspace_134/Semeval2026/Q1/data/predictions_qwen.json"
    MODEL_SAVE_DIR = "/home/luorongchuan/workspace_134/Semeval2026/Q1/out_qwen"
