...
class NLIConfig:
    # ✅ 改为本地路径
    local_model_path: str = "/home/luorongchuan/workspace_134/Semeval2026/Q3/local-model/Qwen2-1.5B-Instruct"
    max_length: int = 512
...
def train_model(data, cfg: NLIConfig):
    ...
    training_args = TrainingArguments(
        output_dir='/home/luorongchuan/workspace_134/Semeval2026/Q3/local-code-noaug/qwen2-1.5b-noaug/out',
        eval_strategy="epoch",
    ...
    model_save_path = "/home/luorongchuan/workspace_134/Semeval2026/Q3/local-code-noaug/qwen2-1.5b-noaug/out"
...
if __name__ == "__main__":
    ...
    cfg = NLIConfig(
        local_model_path="/home/luorongchuan/workspace_134/Semeval2026/Q3/local-model/Qwen2-1.5B-Instruct",
        max_length=512,
        batch_size=16,
        epochs=5,
        learning_rate=1e-5,
    ...
    OUTPUT_FILE = "/home/luorongchuan/workspace_134/Semeval2026/Q3/local-code-noaug/qwen2-1.5b-noaug/predictions.json"
    MODEL_SAVE_DIR = "/home/luorongchuan/workspace_134/Semeval2026/Q3/local-code-noaug/qwen2-1.5b-noaug/out"
