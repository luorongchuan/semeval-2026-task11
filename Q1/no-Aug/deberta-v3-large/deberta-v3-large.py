...
def train_model(data, cfg: NLIConfig):
    ...
    training_args = TrainingArguments(
        output_dir='/home/luorongchuan/workspace_134/Semeval2026/Q1/code/deberta-v3-large-noaug/out',
        eval_strategy="epoch",
    ...
    # 开始训练
    trainer.train()
    trainer.save_model("/home/luorongchuan/workspace_134/Semeval2026/Q1/code/deberta-v3-large-noaug/out")
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "/home/luorongchuan/workspace_134/Semeval2026/Q1/code/deberta-v3-large-noaug/predictions.json"

    # 模型保存路径（与 trainer.save_model 一致）
    MODEL_SAVE_DIR = "/home/luorongchuan/workspace_134/Semeval2026/Q1/code/deberta-v3-large-noaug/out"
